...
public class SkiaButton : SkiaLayout, ISkiaGestureListener
{
    ...
    public override SKPath CreateClip(object arguments, bool usePosition)
    {
        if (MainFrame != null)
        {
            var offsetFrame = new SKPoint(MainFrame.DrawingRect.Left - DrawingRect.Left,
                MainFrame.DrawingRect.Top - DrawingRect.Top);
    ...
    public virtual bool OnDown(TouchActionEventArgs args, SKPoint childOffset, SKPoint childOffsetDirect,
        ...
        SKPoint childOffset, SKPoint childOffsetDirect, ISkiaGestureListener alreadyConsumed)
    {
        ...
        void SetUp()
        {
            Device.BeginInvokeOnMainThread(() => { IsPressed = false; });
        ...
        {
            Device.BeginInvokeOnMainThread(() => { IsPressed = true; });
            _lastDownPts = point;
            hadDown = true;
            TotalDown++;
        ...
        else if (touchAction == TouchActionResult.Tapped)
        {
            TotalTapped++;
