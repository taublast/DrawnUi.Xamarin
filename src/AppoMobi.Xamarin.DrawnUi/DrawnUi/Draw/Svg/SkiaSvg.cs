    ...
    propertyChanged: NeedDraw);
        ...
        */
        ...
        protected void UpdateImageFromString(string source)
        {
            ...
            //replace anything
            if (FontAwesomePrimaryColor != Color.Black)
            {
                source = source.Replace("class=\"fa-primary\"", $"fill=\"{FontAwesomePrimaryColor.ToHex()}\"");
            }
            if (FontAwesomeSecondaryColor != Color.Gray)
            {
        ...
        */
        ...
        SKPaint paint = null)
        {
            ...
            if (IsClippedToBounds || Clipping != null)
            {
                using (SKPath path = new SKPath())
                {
                    ...
                    //var ColorShadow = Color.FromHex("#cccccc");
        ...
        protected override void Paint(SkiaDrawingContext ctx, SKRect destination, float scale, object arguments)
        {
            ...
            if (Svg != null)// !string.IsNullOrEmpty(LoadedString))
            {
                ...
                if (TintColor != Color.Transparent && !UseGradient)
                {
                ...
                else
                {
                    using (var paint = new SKPaint())
                    {
                        ...
                        //                            paint.ColorFilter = SKColorFilter.CreateBlendMode(BackgroundColor.ToSKColor(), SKBlendMode.SrcIn);
